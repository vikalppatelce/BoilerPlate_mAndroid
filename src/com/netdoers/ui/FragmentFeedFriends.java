...
public class FragmentFeedFriends extends Fragment implements IFragmentFriendsCommunicator, OnRefreshListener{
...
//	private ProgressBar mProgress;
	...
	private static String TAG = FragmentFeedFriends.class.getSimpleName();
     ...
     public void onAttach(Activity activity){
       ...
       ((MotherActivity)mContext).mFragmentFriendsCommunicator = this;
     }
...
//	}
	...
	public void passFeedDataToFragment(Feed mFeed, final int mPosition ,String someValue) {
		// TODO Auto-generated method stub
		if(someValue.equalsIgnoreCase("FRIENDS")){
			try{
				...
				getActivity().runOnUiThread(new Runnable() {
					public void run() {
						mFeedAdapter.addFeed(FragmentFeedFriends.this.mFeed);
	...
	private void getLoadMoreData(){
		...
		Log.i(TAG, AppConstants.URLS.URL_POST_FEED_FRIENDS);
		VolleyPostJsonRequest req = nVolley.new VolleyPostJsonRequest(AppConstants.URLS.URL_POST_FEED_FRIENDS, mJSONObject,
