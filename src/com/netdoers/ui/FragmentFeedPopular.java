...
public class FragmentFeedPopular extends Fragment implements IFragmentPopularCommunicator, OnRefreshListener {
...
//	private ProgressBar mProgress;
	...
	private static String TAG = FragmentFeedPopular.class.getSimpleName();
     ...
     public void onAttach(Activity activity){
       ...
       ((MotherActivity)mContext).mFragmentPopularCommunicator = this;
     }
...
//	}
	...
	public void passFeedDataToFragment(Feed mFeed, final int mPosition ,String someValue) {
		// TODO Auto-generated method stub
		if(someValue.equalsIgnoreCase("POPULAR")){
			try{
				...
				getActivity().runOnUiThread(new Runnable() {
					public void run() {
						mFeedAdapter.addFeed(FragmentFeedPopular.this.mFeed);
						mFeedAdapter.notifyDataSetChanged();
						mGridView.setSelection(mPosition);
					}
				});
				if(BuildConfig.DEBUG){
					Log.i(TAG, "passFeedDataToFragmentPopular");
	...
	private void getLoadMoreData(){
		...
		Log.i(TAG, AppConstants.URLS.URL_POST_FEED_POPULAR);
		VolleyPostJsonRequest req = nVolley.new VolleyPostJsonRequest(AppConstants.URLS.URL_POST_FEED_POPULAR, mJSONObject,
