...
public class SubscribedGroupsActivity extends ActionBarActivity implements OnRefreshListener{
	...
	private static final String TAG = SubscribedGroupsActivity.class.getSimpleName();
	...
	private void setActionBar(){
		...
		getSupportActionBar().setTitle(getResources().getString(R.string.activity_subscribed_groups));
	}
	...
	private void setEventListeners(){
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(SubscribedGroupsActivity.this, GroupFeedActivity.class);
	...
	private void getLoadMoreDataVolley(){
		if(Utilities.isInternetConnected()){
			...
			JSONObject mDataJSON = RequestBuilder.getPostStatusGroupIdData("");
			Log.i(TAG, mDataJSON.toString());
			Log.i(TAG, AppConstants.URLS.URL_POST_GROUP_WHILE_POST);
			VolleyPostJsonRequest req = nVolley.new VolleyPostJsonRequest(AppConstants.URLS.URL_POST_GROUP_WHILE_POST, mDataJSON,
...
//										mScrollCount += mPaginationCount;
										...
										if(mAdapter!=null){
					                		   SubscribedGroupsActivity.this.runOnUiThread(new Runnable() {
												public void run() {
					                		   ...
					                		   SubscribedGroupsActivity.this.runOnUiThread(new Runnable() {
												...
												public void run() {
													// TODO Auto-generated method stub
													mAdapter = new GroupAdapter(SubscribedGroupsActivity.this, mGroup, imageLoader, options,false);
							                		mListView.setAdapter(mAdapter); 													
												}
											});  
					                	   }
			...
			Toast.makeText(SubscribedGroupsActivity.this, R.string.noconnection, Toast.LENGTH_SHORT).show();
		}
	}
