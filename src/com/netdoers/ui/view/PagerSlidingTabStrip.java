 ...
 * AIM      		 :- PROVIDE SLIDING TABS WITH ACTUAL INDICATOR SLIDING
 * NOTE: MODIFIED AS PAGERSLIDINGTABSTRIPS INDICATOR AND UNDERLINE INDICATOR 
 * 
 ...
 * TU002      VIKALP PATEL     29/07/2014                       MODIFIED INDICATOR AND UNDERLINE HEIGHT AT TOP
 * --------------------------------------------------------------------------------------------------------------------
 * 
 * *****************************************METHODS INFORMATION******************************************************** 
 * ********************************************************************************************************************
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	protected void onDraw(Canvas canvas) {
		...
		// rectPaint); //SU TU002
		canvas.drawRect(lineLeft, 0, lineRight, indicatorHeight, rectPaint); // EU
																				// TU002
