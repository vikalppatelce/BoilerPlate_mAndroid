...
public class RestClient {
	...
	public static String postJSON(String url, JSONObject dataToSend) throws JSONException{  
	...
	public static String postString(String url, String dataToSend) throws JSONException{  
        // Create a new HttpClient and Post Header
	...
	public static String putJSON(String url, JSONObject dataToSend) throws JSONException{  
        // Create a new HttpClient and Post Header
...
//            httpget.setEntity(se);
	...
	public static String uploadFile(String type, File file, String url) throws UnsupportedEncodingException, ClientProtocolException, IOException{
		...
		FormBodyPart bodyPart = new FormBodyPart("api_key", new StringBody(myVal));
	...
	public static String uploadMediaFile(String type, String post_id,
		...
		String myVal = ApplicationLoader.getPreferences().getApiKey();
		FormBodyPart bodyPart = new FormBodyPart("api_key", new StringBody(myVal));
		FormBodyPart bodyPart1 = new FormBodyPart("post_id", new StringBody(post_id));
	...
	public static String uploadGroupMediaFile(String type, String group_id,
		...
		String myVal = ApplicationLoader.getPreferences().getApiKey();
		FormBodyPart bodyPart = new FormBodyPart("api_key", new StringBody(myVal));
		FormBodyPart bodyPart1 = new FormBodyPart("group_id", new StringBody(group_id));
